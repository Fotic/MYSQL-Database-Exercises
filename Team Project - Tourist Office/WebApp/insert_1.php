...
<title>Εισαγωγή Πελατών στο Τουριστικό Γραφείο</title>
...
<center>
  <table width="400" border="0">
    <tr>
       <td><div align="center" class="style1">Εισαγωγή Πελατών</div></td>
    </tr>
  </table>
  <p align="center"></p>
</center>
    <form method="POST" action="submit_insert_1.php"  name="myform"   accept-charset="UTF-8">
      <center>
      <table>
        <tr>
        <td>
      <div align="center"><strong>Όνομα:</strong> <input name="FName" type="text" size="50" pattern="[A-Za-z\s]+"/></div><br>
      <div align="center"><strong>Επώνυμο:</strong> <input name="LName" type="text" size="50" pattern="[A-Za-z\s]+"/></div><br>
      <div align="center"><strong>Τηλέφωνο:</strong> <input name="Thl" type="text" size="50" pattern="[0-9]{10}"/></div><br>
      <div align="center"><strong>E-mail:</strong> <input name="Email" type="text" size="50" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$"/></div><br>	  
	  <div align="center"> <strong>Ημερ/νία Γέννησης:</strong>  <input type="date" name="Hm_Genisis"></div> 
		</td>
        </tr>
       </table>
        <br/><br/>
