...
<title>Διαγραφή Προσφορών</title>
...
<center>
  <table width="400" border="0">
    <tr>
       <td><div align="center" class="style1">Διαγραφή Προσφορών</div></td>
    </tr>
  </table>
</center><br><br>
    <form method="POST" action="submit_delete_2.php"  name="myform">
      <center>
      <table>
        <tr>
        <td>
		<div align="center"><strong>ID:</strong> 
        <input name="A_APros" type="text" size="20" pattern="\d+"/>
...
//You should create the validator only after the definition of the HTML form
  ...
  frmvalidator.addValidation("A_APros","num","Η τιμή που δώσατε δεν είναι ακέραιος αριθμός!");
      </script>
<center>  	  
